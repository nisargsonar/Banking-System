...
<head>
    ...
    <style>
body {
  background-image: url('img/forbackg.jpg');
...
?>
	...
	<div class="container">
        ...
        <select name="to" class="form-control" required style="background: #628559; color:white"  >
        ...
        <br>
        <br>
            <label style="color : #000;"><b>Amount:</b></label>
            <input type="number" class="form-control" name="amount" required style="background: #628559; color:white">   
            <br><br>
                <div class="text-center" >
            <button class="btn mt-3" name="submit" type="submit" id="myBtn" style="background: white" >Transfer</button>
            </div>
        </form>
    </div>
